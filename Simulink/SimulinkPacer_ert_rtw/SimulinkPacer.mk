...
## Generated on : Mon Oct 17 10:59:14 2022
...
PRODUCT_NAME              = SimulinkPacer
MAKEFILE                  = SimulinkPacer.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/sabri/Documents/Uni_Y3/SoftwareDevelopment_3K04/3k04-pacemaker/Simulink
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = SimulinkPacer_comp.rsp
CMD_FILE                  = SimulinkPacer.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SimulinkPacer.elf
...
DEFINES_STANDARD = -DMODEL=SimulinkPacer -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o mw_sdk_interface.o MW_PWM.o SimulinkPacer.o SimulinkPacer_data.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/SimulinkPacer_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/SimulinkPacer_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/SimulinkPacer_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/SimulinkPacer_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/SimulinkPacer_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/SimulinkPacer_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


SimulinkPacer.o : $(START_DIR)/SimulinkPacer_ert_rtw/SimulinkPacer.c
	$(CC) $(CFLAGS) -o "$@" "$<"


SimulinkPacer_data.o : $(START_DIR)/SimulinkPacer_ert_rtw/SimulinkPacer_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
