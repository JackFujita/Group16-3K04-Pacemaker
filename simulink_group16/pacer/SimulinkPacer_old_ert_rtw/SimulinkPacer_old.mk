###########################################################################
## Makefile generated for component 'SimulinkPacer_old'. 
## 
## Makefile     : SimulinkPacer_old.mk
## Generated on : Mon Nov 28 23:02:04 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/SimulinkPacer_old.elf
...
PRODUCT_NAME              = SimulinkPacer_old
MAKEFILE                  = SimulinkPacer_old.mk
...
COMPILER_COMMAND_FILE     = SimulinkPacer_old_comp.rsp
CMD_FILE                  = SimulinkPacer_old.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SimulinkPacer_old.elf
...
DEFINES_ = -DMW_SERIAL0_RXBUF_SIZE=11 -DMW_SERIAL0_TXBUF_SIZE=2 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__
...
DEFINES_STANDARD = -DMODEL=SimulinkPacer_old -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o mw_sdk_interface.o MW_PWM.o MW_SCI.o SimulinkPacer_old.o SimulinkPacer_old_data.o echo_params_old.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/SimulinkPacer_old_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/SimulinkPacer_old_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/SimulinkPacer_old_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/SimulinkPacer_old_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/SimulinkPacer_old_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/SimulinkPacer_old_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


SimulinkPacer_old.o : $(START_DIR)/SimulinkPacer_old_ert_rtw/SimulinkPacer_old.c
	$(CC) $(CFLAGS) -o "$@" "$<"


SimulinkPacer_old_data.o : $(START_DIR)/SimulinkPacer_old_ert_rtw/SimulinkPacer_old_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


echo_params_old.o : $(START_DIR)/SimulinkPacer_old_ert_rtw/echo_params_old.c
	$(CC) $(CFLAGS) -o "$@" "$<"
