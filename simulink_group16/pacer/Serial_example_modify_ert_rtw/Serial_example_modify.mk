###########################################################################
## Makefile generated for component 'Serial_example_modify'. 
## 
## Makefile     : Serial_example_modify.mk
## Generated on : Fri Nov 25 23:31:17 2022
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Serial_example_modify.elf
...
PRODUCT_NAME              = Serial_example_modify
MAKEFILE                  = Serial_example_modify.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/jackg/Desktop/MECHTR~3/Project/3K04-P~1/SIMULI~1/pacer
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = Serial_example_modify_comp.rsp
CMD_FILE                  = Serial_example_modify.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Serial_example_modify.elf
...
DEFINES_ = -DMW_SERIAL0_RXBUF_SIZE=11 -DMW_SERIAL0_TXBUF_SIZE=5 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__
...
DEFINES_STANDARD = -DMODEL=Serial_example_modify -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_SCI.o Serial_example_modify.o Serial_example_modify_data.o send_parameters.o startup.o system_MK64F12.o startup_MK64F12.o board.o hardware_init.o pin_mux.o fsl_misc_utilities.o fsl_edma_irq.o fsl_uart_irq.o irq_stub.o sbrk.o cmsis_rtos_init.o RTX_Conf_CM.o mw_thread.o mw_semaphore.o mw_timer.o mw_signal.o
...
%.o : $(START_DIR)/Serial_example_modify_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Serial_example_modify_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Serial_example_modify_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/Serial_example_modify_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Serial_example_modify_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Serial_example_modify_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Serial_example_modify.o : $(START_DIR)/Serial_example_modify_ert_rtw/Serial_example_modify.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Serial_example_modify_data.o : $(START_DIR)/Serial_example_modify_ert_rtw/Serial_example_modify_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


send_parameters.o : $(START_DIR)/Serial_example_modify_ert_rtw/send_parameters.c
	$(CC) $(CFLAGS) -o "$@" "$<"
